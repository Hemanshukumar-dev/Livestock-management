...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('google.login')); ?>" class="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 hover:border-slate-400 hover:shadow-md">
...
<?php endif; ?>
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="text-sm font-medium text-green-700 transition hover:text-green-600" href="<?php echo e(route('password.request')); ?>">
                    Forgot password?
                </a>
            <?php endif; ?>
        </div>
    ...
    <p class="mt-6 text-center text-sm text-slate-500">
        ...
        <a href="<?php echo e(route('register')); ?>" class="font-semibold text-green-700 transition hover:text-green-600">
            Create one now
        </a>
    </p>
 <?php echo $__env->renderComponent(); ?>
