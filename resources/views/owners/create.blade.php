                        ...
                        <div class="space-y-3">
                                <div>
                                    ...
                                    <select name="livestock[0][type]" class="typeSelect w-full rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20">
                                        ...
                                        <option value="Goat" @selected(old('livestock.0.type') === 'Goat')>Goat</option>
                                        <option value="Sheep" @selected(old('livestock.0.type') === 'Sheep')>Sheep</option>
                                        <option value="Poultry" @selected(old('livestock.0.type') === 'Poultry')>Poultry</option>
                                    </select>
                                    @error('livestock.0.type')
                            ...
                            <div>
                                ...
                                <select name="livestock[0][health_status]" class="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20">
                                    ...
                                    <option value="Under Treatment" @selected(old('livestock.0.health_status') === 'Under Treatment')>Under Treatment</option>
                                    <option value="Hospitalized" @selected(old('livestock.0.health_status') === 'Hospitalized')>Hospitalized</option>
                                    <option value="Injured" @selected(old('livestock.0.health_status') === 'Injured')>Injured</option>
                                </select>
                                @error('livestock.0.health_status')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function attachTypeListener(entry) {
                ...
                // initialize
                populateBreedSelect(breedSelect, typeSelect.value, entry.querySelector('.breedSelect')?.getAttribute('data-selected'));
            }
            ...
            // Attach remove listener to initial entry and attach type listeners
