<nav x-data="{ open: false }" class="bg-bg-100 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route($dashboardRoute) }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-txt-100" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-txt-200 bg-bg-100 hover:text-txt-200 focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-txt-200 hover:text-txt-200 hover:bg-bg-200 focus:outline-none focus:bg-bg-200 focus:text-txt-200 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-bg-300">
            <div class="px-4">
                <div class="font-medium text-base text-txt-100">{{ Auth::user()->name }}</div>
                <div class="font-medium text-sm text-txt-200">{{ Auth::user()->email }}</div>
            </div>
